 ...
 * @author manue
 */
public class añadirPalabrasIngles extends javax.swing.JDialog {

    /**
     * Constructor que carga los distintos componentes del JDialog
     */
    public añadirPalabrasIngles(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
     ...
     /**
     * Método de JButton que llama al método crearPalabraFrances de InglesOP para cargar la palabra original y traducida a la base de datos Ingles
     * @param evt 
     */
    private void insertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertarActionPerformed
        ...
        iop.crearPalabraIngles(palabra_original.getText(), palabra_traducida.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(añadirPalabrasIngles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                añadirPalabrasIngles dialog = new añadirPalabrasIngles(new javax.swing.JFrame(), true);
